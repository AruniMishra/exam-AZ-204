...
- If backend is accepts HTTP(S), Then Basic AUTH or Certificate will work. Basic client credentials can be defined for HTTP endpoint, not an App Service.
...
- To use your logic app's managed identity(AAD) in your function, you must set your (another)function's **authentication** level to **anonymous**. Otherwise, your logic app throws a "BadRequest" error.
