...
- A certificate cannnot be used to authenticate. Instead run the Invoke-RestMethod or Invoke-WebRequest cmdlet to make a request to the local managed identity for Azure resources endpoint.
...
- Start-AzureStorageBlobCopy - Start-AzureStorageBlobCopy cmdlet starts to copy a blob
