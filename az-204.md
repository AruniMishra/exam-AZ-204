...
- [Azure](#azure)
  ...
  - [- prefer-external to use external cache if configured or internal cache otherwise.](#--prefer-external-to-use-external-cache-if-configured-or-internal-cache-otherwise)
